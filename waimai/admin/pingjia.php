...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="table_big">
 ...
 <tr>
    <td height="30"  background="images/menub4.gif" colspan="2"><div align="center" class="style1">评论管理</div></td>
  </tr>
  ...
  <tr>
    <td height="40" colspan="2" bgcolor="#666666"><table width="750" height="45" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        ...
        <td width="93" bgcolor="#FFFFFF"><div align="center">菜品名称</div></td>
	     ...
	     $pagesize=20;
		   if ($total<=$pagesize){
			...
			if(($_GET[page])==""){
             ...
             $sql1=mysql_query("select * from pingjia where title like '%$title%' order by time desc limit ".($page-1)*$pagesize.",$pagesize ",$conn);
      ...
      <tr>
       ...
       <!-- <td height="20" bgcolor="#FFFFFF">
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center"><a href="lookpinglun.php?id=<?php  echo $info1[id]?>">查看编辑</a></div></td>
